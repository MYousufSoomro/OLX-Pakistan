...
var wishListAds = document.getElementById("wishListAds");
const categories = [
  "null",
  "Cars",
  "Furniture",
...
window.addEventListener("load", () => {
  document.getElementById("wishListAds").innerHTML = "";
  ...
  firebase
    .database()
    .ref("MyWishList/" + uid + "/addId/")
    .once("value", wishListdata => {
      var wishList = wishListdata.val();
